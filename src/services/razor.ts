...
abstract class RazorpayBase extends AbstractPaymentProcessor {
  static identifier = "razropaygateway";
    ...
    this.razorpay_ =
      ...
      new Razorpay({
        ...
        headers: {
          ...
          "X-Razorpay-Account": process.env.RAZORPAY_ACCOUNT ?? undefined,
        },
      });
  }
  ...
  async getPaymentStatus(
    ...
    this.logger.info("checking payment status in razorpay");
  ...
  async updateRazorpayMetadatainCustomer(
    ...
    this.logger.info("updating customer metadata in razorpay");
  ...
  async editExistingRpCustomer(
    ...
    const razorpay_id =
      ...
      this.logger.info("the razorpay id is"+ razorpay_id);
    try {
  ...
  async createRazorpayCustomer(
    ...
    this.logger.info("creating customer in razorpay");
  ...
  async pollAndRetrieveCustomer(
    ...
    this.logger.info("polling for customer in razorpay");
  ...
  async createOrUpdateCustomer(
    ...
    this.logger.info("creating or updating customer in razorpay");
    let razorpayCustomer: Customers.RazorpayCustomer | undefined;
    try {
  ...
  async initiatePayment(
    ...
    this.logger.info("Initiating payment with razorpay");
  ...
  > {
    this.logger.info("authorizing payment in razorpay");
  ...
  > {
    this.logger.info("cancelling payment in razorpay");
  ...
  async capturePayment(
    ...
    PaymentProcessorError | PaymentProcessorSessionResponse["session_data"]
  > {
    this.logger.info("capturing payment in razorpay");
  ...
  async deletePayment(
    ...
    PaymentProcessorError | PaymentProcessorSessionResponse["session_data"]
  > {
    this.logger.info("deleting payment in razorpay");
  ...
  async refundPayment(
    ...
    PaymentProcessorError | PaymentProcessorSessionResponse["session_data"]
  > {
    this.logger.info("  refunding payment in razorpay");
  ...
  async retrievePayment(
    ...
    PaymentProcessorError | PaymentProcessorSessionResponse["session_data"]
  > {
    this.logger.info("retrieving payment in razorpay");
    let intent;
    try {
      const id = (paymentSessionData as unknown as Orders.RazorpayOrder)
        .id as string;
  ...
  async updatePayment(
    ...
    let cart: Cart;
    try {
      this.logger.info("retrieving cart in updatePayment");
    ...
    let customerPhone = "";
    let razorpayId;
    this.logger.info("retrieving customer in updatePayment"+customer.id);
    if (customer) {
      ...
      try {
        ...
        this.logger.info("retrieved customer in updatePayment"+JSON.stringify(refreshedCustomer));
        razorpayId =
  ...
  > {
    this.logger.info("updating payment data in razorpay");
    try {
